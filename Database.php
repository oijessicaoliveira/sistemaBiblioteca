...
class Database {                    // Define uma classe chamada Database, responsável pela conexão ao banco de dados.
    ...
    private $password = "";   // Senha para o banco de dados (geralmente vazia em ambientes locais).
    ...
    public function getConnection() {
        // MySQLi: Uma extensão específica para o MySQL, com suporte para Orientação a Objetos e também Procedural.
